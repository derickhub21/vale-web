    ...
    >
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .vale-tools-section,.vale-plan-preview{margin:28px 0 0;padding:26px;border:1px solid ${C.borderStrong};border-radius:22px;background:linear-gradient(145deg,rgba(24,28,34,.96),rgba(10,12,15,.98));box-shadow:0 18px 50px rgba(0,0,0,.24)}
        ...
        .vale-tools-plan-btn,.vale-back-btn{border:1px solid ${C.borderStrong};background:linear-gradient(180deg,#1B2027,#11151A);color:${C.text};border-radius:12px;padding:11px 15px;font-weight:800;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.04);transition:.18s}
        .vale-tools-plan-btn:hover,.vale-back-btn:hover{border-color:${C.gold};color:${C.gold};transform:translateY(-1px)}
        .vale-tools-plan-btn:disabled{opacity:.55;cursor:not-allowed;transform:none;color:${C.muted};border-color:${C.border}}
        .vale-tools-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}
        .vale-tool-card{text-align:left;border:1px solid ${C.borderStrong};background:linear-gradient(160deg,#171B21,#0F1216);border-radius:18px;padding:18px;color:${C.text} !important;cursor:pointer;transition:.18s;min-height:180px;box-shadow:inset 0 1px 0 rgba(255,255,255,.025),0 8px 22px rgba(0,0,0,.16)}
        .vale-tool-card:hover{transform:translateY(-3px);border-color:${C.gold};box-shadow:0 12px 28px rgba(0,0,0,.28),0 0 0 1px rgba(232,185,74,.08)}
        .vale-tool-card:focus-visible{outline:2px solid ${C.gold};outline-offset:2px}
        ...
        .vale-two-col{display:grid;grid-template-columns:1fr 1fr;gap:14px}.vale-picker-card{border:1px solid ${C.borderStrong};background:linear-gradient(160deg,#171B21,#0F1216);border-radius:18px;padding:18px;box-shadow:0 10px 28px rgba(0,0,0,.16)}.vale-picker-label{font-weight:800;margin-bottom:14px}.vale-picker-grid{display:grid;gap:10px}.vale-picker-grid label,.vale-cost-grid label{display:grid;gap:6px}.vale-picker-grid span,.vale-cost-grid span{font-size:11px;color:${C.muted};font-weight:700}.vale-picker-grid select,.vale-cost-grid input,.vale-ad-textarea{width:100%;border:1px solid ${C.borderStrong};background:${C.surfaceInput};color:${C.text} !important;border-radius:11px;padding:12px;box-shadow:inset 0 1px 5px rgba(0,0,0,.25)}.vale-picker-grid select:focus,.vale-cost-grid input:focus,.vale-ad-textarea:focus{border-color:${C.gold};box-shadow:0 0 0 3px rgba(232,185,74,.08);outline:none}.vale-tool-primary{margin:18px 0;border:0;background:linear-gradient(135deg,#F0C24F,#DDAA35);color:#171006;border-radius:12px;padding:13px 18px;font-weight:900;cursor:pointer;box-shadow:0 8px 20px rgba(232,185,74,.14);transition:.18s}.vale-tool-primary:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 10px 24px rgba(232,185,74,.2)}.vale-tool-primary:disabled{opacity:.5;cursor:not-allowed}.vale-tool-error{margin-top:12px;padding:12px;border-radius:12px;background:rgba(180,50,50,.1);color:${C.red};border:1px solid rgba(180,50,50,.25)}
        .vale-compare-result,.vale-cost-result,.vale-ad-result{border:1px solid ${C.borderStrong};border-radius:20px;background:linear-gradient(160deg,#15191F,#0C0F13);padding:20px;box-shadow:0 12px 30px rgba(0,0,0,.2)}.vale-compare-winner{padding:12px;border-radius:12px;background:rgba(232,185,74,.08);border:1px solid rgba(232,185,74,.18);color:${C.gold};margin-bottom:14px}.vale-compare-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.vale-compare-grid>div{padding:16px;border:1px solid ${C.border};background:rgba(255,255,255,.015);border-radius:14px}.vale-compare-grid span,.vale-compare-grid small{display:block;color:${C.muted};font-size:11px}.vale-compare-grid strong{display:block;font-size:17px;margin:7px 0;color:${C.text}}.vale-compare-grid b{font-family:'JetBrains Mono',monospace;font-size:22px;color:${C.gold}}
        .vale-cost-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:12px}.vale-cost-grid label{padding:15px;border:1px solid ${C.borderStrong};background:linear-gradient(160deg,#171B21,#101318);border-radius:15px}.vale-cost-total{padding:18px;border-bottom:1px solid ${C.border}}.vale-cost-total span{display:block;font-size:11px;color:${C.muted}}.vale-cost-total strong{display:block;font:700 38px 'JetBrains Mono',monospace;color:${C.gold};margin:8px 0}.vale-cost-total small{color:${C.muted}}.vale-cost-lines{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-top:15px}.vale-cost-lines div{display:flex;justify-content:space-between;padding:12px;border-radius:10px;background:${C.surfaceInput};border:1px solid rgba(255,255,255,.025)}.vale-cost-lines b{color:${C.text}}
