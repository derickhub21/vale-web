...
/* =========================================================================
   ...
   `window.storage` (cache, NUNCA autorização): guardamos só o token de
...
async function clearCachedSession() {
  try {
    await window.storage.delete(SESSION_CACHE_KEY, false);
  } catch (e) {
...
// sandbox do Claude Artifact bloqueia por CSP qualquer fetch para
// supabase.co (mesmo problema que já tínhamos com o cadastro/login). Por
// isso ela foi validada no projeto web (vale-web/src/App.jsx), não aqui.
